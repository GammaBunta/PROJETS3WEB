...
(1, 1, 'Risotto aux champignons','2','Plat',1,0,0,0,'Intermédiaire', 45,30,0,'Séparer les champignons en deux (préférer des cèpes) : une partie servira à élaborer le bouillon et cuira avec le riz. </br>
L\'autre partie sera poêlé au dernier moment pour la présentation et mettre en avant le champignon tout en conservant une texture ferme. </br>
Faire blondir dans une casserole un demi-oignon émincé dans un mélange de beurre et d\'huile d\'olive. </br>
Ajouter et poêler les champignons. </br>
Ajouter du bouillon de légume ou de poule (assez pour nourrir le risotto). </br>
Laisser mijoter le bouillon pour qu\'il s\'imprègne bien du goût et des saveurs des champignons.</br>
Pendant ce temps, émincer un petit peu d\'ail, d\'échalote et de persil séparément et réserver.</br>
Chauffer une nouvelle casserole (qui accueillera le risotto), ajouter un peu d\'huile d\'olive et de beurre que vous ferez blondir.</br>
Ajouter le riz carnaroli et remuer jusqu\'à le rendre translucide (attention à la température, le riz ne doit pas coller).</br>
Déglacer avec un verre de vin blanc sec.</br>
Continuer à remuer pour que le riz n\'adhère pas et laisser réduire l\'alcool.</br>
Verser une louche de bouillon que vous avez laissé mijoter et continuer à remuer constamment jusqu\'à l\'absorption totale du riz.</br>
Réitérer l\'étape 10 jusqu\'au point de cuisson (préférer al dente).</br>
Juste avant la fin, faire fondre du beurre et un peu d\'huile d\'olive dans une poêle tout en remuant le risotto.</br>
Faire blondir l\'échalote émincée dans la poêle puis ajouter l\'ail (attention à ne pas le brûler).</br>
Faire poêler les champignons tout en remuant le risotto, assaisonner et ajouter le persil émincé en fin de cuisson avec un tour de moulin à poivre puis réserver.</br>
Assaisonner le risotto juste avant la fin.</br>
Dresser le riz dans des assiettes creuses. Placer soigneusement sur le haut les champignons poêlés.</br>
Ciseler du persil et parsèment le plat pour la présentation.</br>
Servir avec un tour de moulin à poivre et du parmesan.</br>
...
INSERT INTO Recette (idrec,idUser,titre, nbpers, categorie, vegetarien, gluteenFree, avisPositif,avisNegatif, niveau, tpsprepa, tpscuisson, tpsrepose, textrec, img, nombreAvis) values
(2,1,'Lasagnes','4','Plat',0,0,0,0,'Intermédiaire',90,35,0,'Laver et hacher finement l\'oignon, la carotte et la branche de céleri (en ayant pris soin d\'en retirer les feuilles que l\'on réserve pour plus tard).</br>
Dans une marmite ou une cocotte, verser un fond d\'huile d\'olive et y ajouter la moitié du mélange préalablement préparé, puis y ajouter toute la tomate.</br>
Ajouter ensuite un bouquet constitué des feuilles de céleri et de deux branches de basilic entières, bouquet que l\'on retirera en fin de cuisson de la sauce</br>
Préparer une béchamel classique et la réserver.</br>
Prendre ensuite un autre récipient et y ajouter un fond d\'huile d\'olive, le reste de hachis (oignon + carotte + céleri), puis ajouter la chair à saucisse, laisser cuire environ 5 minutes et ajouter le boeuf.</br>
Lorsque le mélange a pris sa couleur, le retirer du feu et le mélanger avec la béchamel.</br>
Si vous avez le temps, laissez cuire la sauce tomate environ 1 heure à feux doux en rajoutant un peu d\'eau si nécessaire.</br>
...
INSERT INTO Recette (idrec,idUser,titre, nbpers, categorie, vegetarien, gluteenFree, avisPositif,avisNegatif, niveau, tpsprepa, tpscuisson, tpsrepose, textrec, img, nombreAvis) values
(3,1,'Croque-monsieur','4','Plat',0,0,0,0,'Facile',10,5,0,'Beurrez les 8 tranches de pain de mie sur une seule face. Posez 1 tranche de fromage sur chaque tranche de pain de mie. Posez 1 tranche de jambon plié en deux sur 4 tranches de pain de mie. Recouvrez avec les autres tartines (face non beurrée au dessus).</br>
Dans un bol mélanger le fromage râpé avec le lait, le sel, le poivre et la muscade.</br>
Répartissez le mélange sur les croque-monsieur.</br>
...
(4,1,'Tagliatelle carbonara','4','Plat',0,0,0,0,'Facile',10,20,0,'
    Faites revenir l\'oignon et l\'ail émincés dans un peu d\'huile d\'olive. Ajoutez ensuite les lardons. Faites les dégraisser à feu moyen quelques minutes. Versez le vin blanc et laisser réduire.</br>
Faite bouillir un large volume d\'eau, ajoutez du sel et une coulée d\'huile d\'olive, puis plongez-y les pâtes pour une cuisson al-dente.</br>
Une fois le vin blanc presque entièrement réduit, versez la crème fraîche, portez la à ébullition puis retirez le tout du feu. Gardez au chaud le temps que les pates soient prêtes.</br>
Sortez les pâtes, égouttez-les et servez-les dans les assiettes.</br>
...
(5,1,'Charlotte au chocolat','6','Dessert',1,0,0,0,'Facile',45,0,0,'
    Beurrer légèrement un moule à charlotte et disposer dans le fond un rond de papier sulfurisé.</br>
Verser 10 cl d\'eau et le rhum dans le fond d\'une assiette creuse.</br>
Tremper rapidement les biscuits et tapisser entièrement le fond et les bords du moule (côté bombé vers l\'extérieur).</br>
Séparer les jaunes d\'oeufs des blancs.</br>
Mettre à fondre le chocolat avec le lait dans un saladier à bain-marie doux. Le laisser fondre entièrement et le lisser avec une spatule en bois. En maintenant la préparation au bain-marie ajouter peu à peu le beurre en petits morceaux tout en remuant, puis les jaunes d\'oeuf l\'un après l\'autre. Travailler la crème quelques instants jusqu\'à ce qu\'elle soit bien lisse et brillante puis retirer la casserole du feu et laisser refroidir. </br>
Monter les blancs d\'oeuf en neige en ajoutant à la fin le sucre glace en pluie.</br>
Battre la crème liquide (très froide) en chantilly un peu molle.</br>
Incorporer les deux préparations à la crème afin d\'obtenir un mélange lisse et parfaitement homogène.</br>
Remplir le moule avec la mousse au chocolat en la tassant légèrement, terminer par une couche de biscuits imbibés. Couvrir d\'une assiette, un poids dessus et mettre au frigo jusqu\'au lendemain.</br>
